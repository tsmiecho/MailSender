...
<table>
	<tbody>
		<tr>
			<td>1.03.2014 - 30.04.2014</td>
			<td>Centrum Informatyki Uniwersytetu Łódzkiego</td>
		</tr>
		<tr>
			<td>Brałem udział w projekcie wewnątrz Uniwersytetu. Zajmowaliśmy się automatyzacją księgowości.
			Była to praca na pół etatu, dostosowana do zajęć na uczelni. Korzystaliśmy z technologii 
			firmy Microsoft, głównie VisualBasic, SQL Server 2012 oraz systemu SIMPLE.ERP.</td>
		</tr>
		<tr>
			<td>5.05.2014 - 31-07-2014</td>
			<td>AMG.net Łódź</td>
		</tr>
		<tr>
			<td>Odbywałem wtedy praktyki zawodowe. Przez pierwszy miesiąc prowadzone były szkolenia przez starszych kolegów.
			 Podczas szkoleń pokazano nam wiele ciekawych technologii dotyczących tworzenia aplikacji webowych. 
		...
		<tr>
			...
			Zaznajomiłem się z wieloma narzędziami: JavaEE, ATG, Eclipse, SQLDeveloper, Jenkins, JBoss, JAXB, XStream, MemCached, Freemarker, Ant, SVN.
			 </td>
		</tr>
		<tr>
		...
		<tr>
			<td>TODO oraz na dole wykres HighChart z technologia/poziom zaawansowania</td>
		</tr>
	</tbody> 
</table>
